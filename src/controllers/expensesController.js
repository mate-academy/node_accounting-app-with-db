...
const getExpenseById = async (req, res) => {
  ...
  const expenses = await expensesServices.getExpensesById(expenseId);
...
const updateExpense = async (req, res) => {
  ...
  const expense = expensesServices.getExpensesById(expenseId);
  ...
  const updatedExpense = await expensesServices.getExpensesById(expenseId);
